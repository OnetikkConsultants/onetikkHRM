...
namespace HRM.Core
{
    public class Culture
    {
        ...
        /// <summary>
        /// Sets the nearest matching culture that we support in the application
        /// </summary>
        /// <param name="cultureName"></param>
        public static void SetNearestImplementedCulture(string cultureName)
        {
            // Get the nearest culture we support
            cultureName = Culture.GetImplementedCulture(cultureName);

            // Set current thread's cultures            
        ...
        {
            return ImplementedCultures[0]; // return Default culture
        }
        ...
        // List of ONLY the cultures we are implementing
        public static readonly List<string> ImplementedCultures = new List<string>
        {
            "en-US",	// first culture is the DEFAULT
			"en-TT",	// Psuedo-English culture for testing (using Trinida & Tobago's culture code for this)
			"es",		// Spanish NEUTRAL culture
		};

        // List of all valid cultures
